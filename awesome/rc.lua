...
batterywidget_timer:connect_signal("timeout", function()
    bat0_widget:set_text(batteryInfo("BAT0"))
    bat1_widget:set_text(batteryInfo("BAT1"))
end)
...
clientkeys = awful.util.table.join(
    ...
    -- マルチスクリーンの時に別のスクリーンにClientを移動する
    ...
    globalkeys = awful.util.table.join(globalkeys,
        ...
        awful.key({ modkey }, "#" .. i + 9,
                  function ()
                        ...
                        if master then
                            awful.client.jumpto(master)
                        end
                  end),
        -- 指定したtagの内容を現在のtagにも表示
        ...
        -- Focusの当たっているClientを押した数字のスクリーンに表示させる
...
awful.rules.rules = {
    ...
    { rule = { class = "Mikutter.rb" }, except = { name = "mikutter"},
